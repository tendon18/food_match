class RankingsController < ApplicationController
  ...
  def score
    ...
    @avoid_reason = @group.group_members.all? do |group_member|
      participant_condition = group_member.participant_condition

      next true unless participant_condition

      participant_condition.participant_condition_avoids.all? do |participant_avoid|
